...
module.exports.run = async ({ event, api }) => {
  ...
  api.sendMessage("───༅༎ 𝘾𝙤𝙢𝙢𝙖𝙣𝙙 𝙡𝙞𝙨𝙩 ༎───༅\n" 
                  + "\n01. 𝙚𝙙𝙞𝙩 𝙗𝙤𝙩 𝙗𝙞𝙤" + "\n02. 𝙚𝙙𝙞𝙩 𝙗𝙤𝙩 𝙣𝙞𝙘𝙠𝙣𝙖𝙢𝙚𝙨" + "\n03. 𝙫𝙞𝙚𝙬 𝙥𝙚𝙣𝙙𝙞𝙣𝙜 𝙢𝙚𝙨𝙨𝙖𝙜𝙚𝙨" + "\n04. 𝙫𝙞𝙚𝙬 𝙪𝙣𝙧𝙚𝙖𝙙 𝙢𝙚𝙨𝙨𝙖𝙜𝙚𝙨" + "\n05. 𝙫𝙞𝙚𝙬 𝙨𝙥𝙖𝙢 𝙢𝙚𝙨𝙨𝙖𝙜𝙚𝙨" + "\n06. 𝙘𝙝𝙖𝙣𝙜𝙚 𝙗𝙤𝙩 𝙥𝙧𝙤𝙛𝙞𝙡𝙚 𝙥𝙞𝙘𝙩𝙪𝙧𝙚" + "\n07. 𝙩𝙪𝙧𝙣 𝙤𝙣 𝙩𝙝𝙚 𝙗𝙤𝙩 𝙖𝙫𝙖𝙩𝙖𝙧 𝙨𝙝𝙞𝙚𝙡𝙙 (𝙤𝙣/𝙤𝙛𝙛)" + "\n08. 𝙗𝙡𝙤𝙘𝙠 𝙪𝙨𝙚𝙧𝙨 (𝙢𝙚𝙨𝙨𝙚𝙣𝙜𝙚𝙧)" + "\n09. 𝙪𝙣𝙗𝙡𝙤𝙘𝙠 𝙪𝙨𝙚𝙧𝙨 (𝙢𝙚𝙨𝙨𝙚𝙣𝙜𝙚𝙧)" + "\n10. 𝙘𝙧𝙚𝙖𝙩𝙚 𝙥𝙤𝙨𝙩" + "\n11. 𝙙𝙚𝙡𝙚𝙩𝙚 𝙥𝙤𝙨𝙩" + "\n12. 𝙙𝙚𝙡𝙚𝙩𝙚 𝙥𝙤𝙨𝙩 (𝙪𝙨𝙚𝙧)" + "\n13. 𝙘𝙤𝙢𝙢𝙚𝙣𝙩 𝙩𝙝𝙚 𝙥𝙤𝙨𝙩 (𝙜𝙧𝙤𝙪𝙥)" + "\n14. 𝙙𝙧𝙤𝙥 𝙥𝙤𝙨𝙩 𝙛𝙚𝙚𝙡𝙞𝙣𝙜𝙨" + "\n15. 𝙢𝙖𝙠𝙚 𝙛𝙧𝙞𝙚𝙣𝙙𝙨 𝙗𝙮 𝙞𝙙" + "\n16. 𝙖𝙘𝙘𝙚𝙥𝙩 𝙛𝙧𝙞𝙚𝙣𝙙 𝙧𝙚𝙦𝙪𝙚𝙨𝙩 𝙗𝙮 𝙞𝙙" + "\n17. 𝙙𝙚𝙘𝙡𝙞𝙣𝙚 𝙛𝙧𝙞𝙚𝙣𝙙 𝙧𝙚𝙦𝙪𝙚𝙨𝙩 𝙗𝙮 𝙞𝙙" + "\n18. 𝙙𝙚𝙡𝙚𝙩𝙚 𝙛𝙧𝙞𝙚𝙣𝙙𝙨 𝙗𝙮 𝙞𝙙" + "\n19. 𝙨𝙚𝙣𝙙 𝙖 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙗𝙮 𝙞𝙙" + "\n20. 𝙢𝙖𝙠𝙚 𝙣𝙤𝙩𝙚𝙨 𝙤𝙣 𝙗𝙪𝙞𝙡𝙙𝙩𝙤𝙤𝙡.𝙙𝙚𝙫" + "\n21. 𝙡𝙤𝙜 𝙤𝙪𝙩 𝙤𝙛 𝙮𝙤𝙪𝙧 𝙖𝙘𝙘𝙤𝙪𝙣𝙩" + `\n\n𝙥𝙡𝙚𝙖𝙨𝙚 𝙧𝙚𝙥𝙡𝙮 𝙩𝙤 𝙩𝙝𝙞𝙨 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙬𝙞𝙩𝙝 𝙩𝙝𝙚 𝙤𝙧𝙙𝙚𝙧 𝙣𝙪𝙢𝙗𝙚𝙧 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙚𝙭𝙚𝙘𝙪𝙩𝙚`, threadID, (err, info) => {
    global.client.handleReply.push({
      name: this.config.name,
      messageID: info.messageID,
      author: senderID,
