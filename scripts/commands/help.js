...
module.exports.languages = {
  en: {
    ...
    guideList:
      `— 𝐔𝐬𝐞: "%1${this.config.name} 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐧𝐚𝐦𝐞" 𝐓𝐨 𝐤𝐧𝐨𝐰 ,𝐇𝐨𝐰 𝐭𝐨 𝐮𝐬𝐞 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 ?!\n𝐀𝐧𝐝 𝐓𝐲𝐩𝐞: "%1${this.config.name} 𝐏𝐚𝐠𝐞 𝐍𝐮𝐦𝐛𝐞𝐫" 𝐭𝐨 𝐬𝐡𝐨𝐰 𝐎𝐭𝐡𝐞𝐫 𝐩𝐚𝐠𝐞 !`,
    user: "User",
...
│ Page ${numberFontPage[currentPage - 1]} of ${
    ...
    const msgg = {
  body: `╭──────────────╮\n│𝖢𝗈𝗆𝗆𝖺𝗇𝖽 & 𝖢𝖺𝗍𝖾𝗀𝗈𝗋𝗒│\n╰──────────────╯\n‣ Bot Owner: ${config.ADMINNAME}\n\n` + msg + `\n◖Total pages available: ${totalPages}.\n\n${config.ADMINNAME}` + `\n╭ ──── ╮\n│ GUIDE │\n╰ ──── ╯\n` + getText("guideList", config.PREFIX),
  attachment: imgP,
};
    const sentMessage = await api.sendMessage(msgg, threadID);
